...
function peg$parse(input: string, options?: IParseOptions) {
  ...
  const peg$c4 = function(s: any, w1: any, l: any, w2: any, f: any): any { 
    return `<strong>${s}</strong>` + w1 + l + w2 + f; 
  };
  const peg$c5 = "from";
  const peg$c6 = peg$literalExpectation("from", false);
  const peg$c7 = function(f: any, w1: any, j: any, w: any, g: any): any { 
  ...
  const peg$c17 = function(g: any): any {
  ...
  const peg$c31 = function(s: any, d: any): any { 
  ...
  const peg$c42 = function(p: any): any { 
  ...
  const peg$c50 = function(r: any): any { return r; };
  const peg$c51 = peg$otherExpectation("tablename");
  const peg$c52 = /^[0-9a-zA-Z.]/;
  const peg$c53 = peg$classExpectation([["0", "9"], ["a", "z"], ["A", "Z"], "."], false, false);
  const peg$c54 = function(t: any): any { return t.join(""); };
  const peg$c55 = peg$otherExpectation("fieldname");
  const peg$c56 = /^[0-9a-zA-Z]/;
  const peg$c57 = peg$classExpectation([["0", "9"], ["a", "z"], ["A", "Z"]], false, false);
  const peg$c58 = function(f: any): any { return f.join(""); };
